...
import java.util.List;
 ...
 // @Service will be the created services for our @RestController Which is the controller to speak to our database. Think of @Service as the services for which buttons will provide for a Tv remote; the TV remote being the @RestController for which will speak to the database in the UseService class, we will create CRUD functions for creating accounts. WE have created endpoints for these CRUD functions within the controller layer package
@Service
