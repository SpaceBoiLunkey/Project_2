...
<TopContainer>
  ...
  <img src={ZA} alt=""/>
    ...
    <Title ><b>
    WELCOME TO YOUR NIGHTMARE</b></Title>
    <br/>
     <Body>
        Get ready to engage in a dazzling new sensation that is sweeping the internet across
    ...
    <SubBody>
        ...
        to the zombie destruction, by cross breeding alien birds with earth chickens.
         ...
         who has now been dragged into all-consuming darkness. An ancient force of
          ...
          <Link to="/Login" ><Button>PLAY!!</Button></Link>
