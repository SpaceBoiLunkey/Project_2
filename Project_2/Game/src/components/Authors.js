    ...
    <form className="flex justify-content max-w-xs mx-auto mt-5">
      <div className="pt-5">
        ...
        <div>
          <h4>
            <br></br>
            "Zombie Apocalypse: In Space" was written by Kalvin McClure of
            Zombie Apocalypse Inc. Donald Lopez edited the story. Together, the
            two of them dreamed up the concept of the game and laid the
            foundation for the website.
            <br></br>
            <br></br>
            Drael Davidson and Eric Vara helped build the website alongside
            Donald and Kalvin. Eric handled the backend database while Drael
            helped build a lot of the community pages with Donald. Kalvin built
            the actual game itself.<br></br>
