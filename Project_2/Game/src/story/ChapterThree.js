...
export default function ChapterThree() {
        ...
        Something isn't adding up. Unless this threat is actually credible, your room will be more than safe from any random attack or threat. You could go back to sleep, and accept your fate, or open the door to see what's up.</h4>
        <div class="container">
    
    <Link to="/ChapterSix" type="submit" className="btn btn-success btn-lg btn-block mt-5 mr-1">See what's up?</Link>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <Link to="/ChapterSeven" type="submit" className="btn btn-success btn-lg btn-block mt-5">Accept your fate?</Link>
                <>
            <Fader></Fader>
                </>
    <br></br>
