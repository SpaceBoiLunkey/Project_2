...
export default function ChapterSix() {
        return (
            ...
            <div>
        <h4><br></br>
        Making a choice that would surely affect your survivability for the better, you decide to open the door and see what's up. Standing in the doorway is a crewmate, looking sweaty and disrupted from something.<br></br>
        "What's going on?" you ask hesitantly.<br></br>
        "Zombies," he says, breathing heavily, "and they're coming quick. Alterra doesn't have a protocol for something like this. We have to escape!"<br></br>
        "Zombies?" you ask, very confused.<br></br>
        "There's no time, please come with me!"<br></br>
        You follow the crewmate down the hall to an escape pod. "Wait here while I grab one more person," he says. You nod and turn your back to the wall so you can see what's going on. As you watch him run down a hallway, you begin to hear what sounds like a slight grunting or moaning. You realize that there are zombies running down the hallway. Your only option is to jump into the escape pod and hope that your friend returns soon.<br></br>
