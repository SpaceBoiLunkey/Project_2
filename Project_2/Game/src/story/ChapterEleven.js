...
export default function ChapterEleven() {
        ...
        After a few days of surviving in this small space with everyone, you're starting to get tired of them. There's a person with a weird voice, and you don't like it when that other guy chews weirdly. You're hoping for something... anything, as an excuse to leave.<br></br>
        ...
        "If you want any chance of survival, you'll come with me," he tells you.<br></br>
        "How do you even know me?" you ask.<br></br>
        "Oh trust me, we go way back!" he says, winking. "Come with me and you'll survive, This is your last chance," he whispers, so that only you can hear.<br></br>
        You look back at the captain and the rest of the crew. They all give you disapproving looks. Do you...
        </h4>
        <div class="container">
    
    <Link to="/ChapterSixteen" type="submit" className="btn btn-success btn-lg btn-block mt-5">Stay with the crew?</Link>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <Link to="/ChapterSeventeen" type="submit" className="btn btn-success btn-lg btn-block mt-5">Escape with mustache guy?</Link>
                <>
            <Fader></Fader>
                </>
    <br></br>
