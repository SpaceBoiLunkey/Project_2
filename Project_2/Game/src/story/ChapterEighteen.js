...
export default function ChapterEighteen() {
        return (
            ...
            <div>
        <h4><br></br>
        There's no way that they could have made it to the pod in time anyway to escape, so you selfishly take their place and decide to jettison the pod without them afterall. After a while, your escape pod finds another alien ship to dock with, and the aliens welcome you on board as a refugee. You live out the rest of your life on this ship, far away from everyone and everything you've ever known and loved. <br></br>Ending 8/10</h4>
        <div class="container">
    
        <Link to="/Start" type="submit" className="btn btn-warning btn-lg btn-block mt-5">Try again?</Link>
                <>
            <Fader></Fader>
                </>
    <br></br>
